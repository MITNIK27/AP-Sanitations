                        ...
                        >
                          {effectiveSrc ? (
                            ...
                            <div className="relative aspect-[4/3] bg-linen overflow-hidden">
                              {(BRAND_LOGOS[brand.id] ?? brand.imageSrc) ? (
                                <Image
                                  src={BRAND_LOGOS[brand.id] ?? brand.imageSrc!}
                                  alt={brand.name}
                                  fill
                                  sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
                                ...
                                <div
                                  className="absolute inset-0"
                                  style={{ background: brand.placeholderGradient ?? 'linear-gradient(135deg, #EDE9E1 0%, #F7F5F0 100%)' }}
                                />
                              )}
                            </div>
                          )}
